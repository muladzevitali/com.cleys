...
<head>
	...
	<title>Aanbod – Product detail</title>
...
<body>
	<div class="wrapper product-detail-page">
						...
						<div class="product-detail__right">
							<form action="" method="">
								...
								<div class="product-detail__price">
									<div class="cur-price"><span>€ 85,00</span> incl. BTW</div>
								</div>
								...
								<!-- NOTE Also examples of possible blocks -->
								<!-- <div class="product-detail__stock stock --orange"><i class="fas fa-exclamation-triangle"></i> Beperkte voorraad</div> -->
								<!-- <div class="product-detail__stock stock --red"><i class="fas fa-times"></i> Out of stock</div> -->
								<div class="product-detail__for-pro">
									<h5><i class="fal fa-hard-hat"></i>Professional met BTW nummer?</h5>
									<div><a href="#">Maak een account</a> en bekijk onze <strong>prijzen voor professionals</strong>, alsook tal van andere <strong>voordelen</strong>!</div>
								</div>
